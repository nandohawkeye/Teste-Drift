...
class EmployeeData extends DataClass implements Insertable<EmployeeData> {
  ...
  factory EmployeeData.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return EmployeeData(
      ...
      dateOfBirth: const DateTimeType()
          .mapFromDatabaseResponse(data['${effectivePrefix}date_if_birth'])!,
    );
  }
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['date_if_birth'] = Variable<DateTime>(dateOfBirth);
    return map;
  }
...
class EmployeeCompanion extends UpdateCompanion<EmployeeData> {
  ...
  static Insertable<EmployeeData> custom({
    ...
    return RawValuesInsertable({
      ...
      if (dateOfBirth != null) 'date_if_birth': dateOfBirth,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (dateOfBirth.present) {
      map['date_if_birth'] = Variable<DateTime>(dateOfBirth.value);
    }
    return map;
  }
...
class $EmployeeTable extends Employee
  ...
  late final GeneratedColumn<DateTime?> dateOfBirth =
      GeneratedColumn<DateTime?>('date_if_birth', aliasedName, false,
  ...
  VerificationContext validateIntegrity(Insertable<EmployeeData> instance,
    ...
    if (data.containsKey('date_if_birth')) {
      context.handle(
          _dateOfBirthMeta,
          dateOfBirth.isAcceptableOrUnknown(
              data['date_if_birth']!, _dateOfBirthMeta));
    } else if (isInserting) {
